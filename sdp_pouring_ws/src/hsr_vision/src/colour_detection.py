...
cv2.createTrackbar('Height', 'Glass size', 0, 500, nothing)
cv2.createTrackbar('Width', 'Glass size', 0, 500, nothing)
...
def callback(data, target):
    ...
    cv2.rectangle(current_frame,(250-w_glass/2, 370-h_glass), (250,370), (0,255,0),2)

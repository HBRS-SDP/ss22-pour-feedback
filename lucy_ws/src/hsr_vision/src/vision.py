...
def callback(data):
    ...
    mask_focus = mask[68:362,178:315]  #focus on glass only with 2 pixels more in each direction
    ...
    if len(contours)!=0:
        ...
        cv2.rectangle(current_frame,(x+175,y+65),(x+175+w,y+65+h),(0,255,0),2)
